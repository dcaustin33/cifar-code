...
#custom imports
from utils.utils import  top_1_error_rate_metric, top_5_error_rate_metric
import cifar_100_data
import utils.flax_trainer as trainer
from flax.training import train_state
from models.flax_cifar_resnet import resnet18
import cifar_100_data


def prepare_data(dataset_args, val_dataset_args):
    
    train_dataset = cifar_100_data.CIFAR_100_transformations(root = args.data_path, train = True, **dataset_args)
    ...
    val_dataset = cifar_100_data.CIFAR_100_transformations(root = args.data_path,views = 1, train = True, **val_dataset_args)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--log_n_train_steps', default = 1000, type = int)
