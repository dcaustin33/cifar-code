#custom batch norm and ema taken from the haiku documentation
...
class ExponentialMovingAverage(hk.Module):
  ...
  def __call__(
    ...
    counter = hk.get_state("counter", (), jnp.float32,
...
hk.initializers = initializers
hk.Module = module.Module
hk.ExponentialMovingAverage = ExponentialMovingAverage
